...
| C — monitors, synchronized methods, wait sets, and interruption | In progress | `docs/workstreams/r2-concurrency-candidate-evidence/7aeb0aa/slice-c/` — `7aeb0aa` (rework), 11/11 fixtures Interpreter + IR (1x + 20x stress), all gates Pass |

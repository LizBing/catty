...
- [x] 计划建立（2026-08-23）
- [x] R-0002 完成（2026-08-23）：推荐 F 方案，置信度 0.68，
      临界异常频率 0.6%/0.06%，含栈深 guard 共同缺口发现
- [x] T1 emitter-abi.md v0.1 草案落盘
- [x] T2 ADR-0009 定稿（F 方案 v1 默认；P 降级 v2 热点优化）
- [ ] T3 ADR-0010 表示法边界（判断一评审后定稿）
- [ ] R-0003 进行中（后台）；T4..T8 待实现轮启动
